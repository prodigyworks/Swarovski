...
//    }
	...
	$result .= $this->HeaderLine("Organization" , "inter-cloud.co.uk"); 
	...
	$result .= $this->HeaderLine("X-AntiAbuse" , "This is a solicited email for - "."inter-cloud.co.uk"." mailing list.");
	$result .= $this->HeaderLine("X-AntiAbuse" , "Servername - {$_SERVER['SERVER_NAME']}");
	$result .= $this->HeaderLine("X-AntiAbuse" , $this->Sender);
	$result .= $this->HeaderLine("Return-Path" , $this->From . " <" . $this->FromName . ">");
