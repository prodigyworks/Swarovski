	...
	function extend() {
		...
		if ($result) {
			while (($member = mysql_fetch_assoc($result))) {
				...
				$reason = mysql_escape_string($member['reason'] . "\n\nLoan is extended – product already in your possession");
			}
...
//				}
				...
				$signatureemail_jc = getSiteConfigData()->signatureemail . "Please follow the link below and log in using your unique credentials.<br /><br />Web address: http://optiks.inter-cloud.co.uk<br>Login : " . $theloginjc . "<br>Password : " . $thepasswordjc;
